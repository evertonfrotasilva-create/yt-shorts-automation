...
FALLBACK_QUERIES = [
    "cross sunset sky cinematic dark", "bible open book light dark",
    "sunrise hope dawn peaceful dark cinematic", "nature peaceful water calm dark",
    "mountain majestic landscape dark cinematic", "candle flame glow dark",
    "person praying silhouette dark", "light rays clouds divine dark",
    "forest path nature spiritual dark", "stars night sky peaceful dark",
]

# Mapeamento stem → query visual para Pexels
# Chave = prefixo (stem) da palavra; valor = query com intenção visual clara
CONCEPT_QUERIES = {
    "faith":    "cross church faith sunset dark cinematic",
    "lov":      "heart light sunset warmth dark cinematic",
    "hop":      "sunrise hope dawn light peaceful dark",
    "pray":     "person praying hands silhouette dark",
    "god":      "sky clouds light rays divine dark",
    "lord":     "sky light divine rays dark cinematic",
    "peac":     "peaceful water lake calm reflection dark",
    "strength": "mountain strong majestic bold dark",
    "grac":     "soft light grace gentle glow dark",
    "trust":    "path nature walk faith calm dark",
    "spirit":   "spirit light soul glow cinematic dark",
    "life":     "nature growth sunrise green dark cinematic",
    "salvat":   "cross light salvation sky dark",
    "fear":     "shadow darkness dramatic cinematic dark",
    "joy":      "sunrise joy celebration light dark",
    "wisdom":   "book light knowledge open pages dark",
    "heart":    "heart warmth light glow dark",
    "truth":    "light revelation dramatic dark cinematic",
    "bless":    "light blessing sky hands dark",
    "promis":   "rainbow sky light hope dark",
    "word":     "bible book open scripture light dark",
    "heaven":   "sky clouds light divine golden dark",
    "sin":      "shadow darkness redemption dramatic dark",
    "forgiv":   "light forgiveness grace soft dark",
    "holy":     "church light spiritual glow stained glass dark",
    "jesus":    "cross light divine sunset dark cinematic",
    "christ":   "cross light glory sky dark cinematic",
    "mercy":    "light mercy grace soft hands dark",
    "eternal":  "stars night sky infinite dark cinematic",
    "kingdom":  "mountain sky majestic clouds dark",
    "righteous": "light path righteousness walk dark",
    "templ":    "church cathedral architecture dramatic dark",
    "discipl":  "path walking following light dark",
    "grace":    "soft light grace gentle glow dark",
    "verse":    "bible open scripture light dark",
    "scripture": "bible scripture text light dark",
    "soul":     "spirit soul light glow dark cinematic",
    "comfort":  "peaceful calm nature serene dark",
    "courage":  "mountain bold strength dark cinematic",
    "humbl":    "person kneeling gentle light dark",
    "patient":  "calm water waiting peaceful dark",
    "power":    "storm lightning dramatic power dark",
    "glory":    "golden light glory sky rays dark",
    "angel":    "light wings divine sky dark cinematic",
    "sanctif":  "pure light white glow dark",
    "redeem":   "light redemption cross dark cinematic",
    "deliver":  "open door light freedom dark",
    "generos":  "giving hands light share dark",
    "grateful": "sunrise gratitude peaceful light dark",
    "purpos":   "path road destination light dark",
    ...
    "obey":      "obedience path follow light dark",
    "promis":    "rainbow promise sky light dark",
    "number":    "bible verse text scripture dark",
    "future":    "horizon sunrise hope vision dark",
    "time":      "time sunset clock peaceful dark",
    "build":     "building foundation stone dark",
    "renew":     "sunrise renewal fresh light dark",
    "transfor":  "butterfly transformation light dark",
    "abundan":   "nature abundance harvest light dark",
    "protec":    "shield light protection dark cinematic",
}
